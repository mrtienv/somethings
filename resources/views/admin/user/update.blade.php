                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" {{empty($oneItem) ? 'required' : ''}} name="author" type="text" value="{{$oneItem->author ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Url tác giả</label>
                                                <input class="form-control" {{empty($oneItem) ? 'required' : ''}} name="url_author" type="text" value="{{$oneItem->url_author ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                        <div class="form-group">
