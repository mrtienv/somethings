                ...
                <div class="header-top-left">
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <ul class="header-top-contact">
                            ...
                            <li><i class="fa fa-envelope-o" aria-hidden="true"></i>info@trabble.com</li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-sm-2 col-xs-12 tap-v-responsive">
                    <div class="logo-area">
                        <a href="index-2.html"><img src="web/images/logo.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-10">
                    <nav>
                        <ul class="main-menu text-right">
                            <li class="active"><a href="index-2.html">Home</a>
                                <ul class="dropdown">
                                    <li><a href="index-2.html">Home V1</a>
                                    </li>
                                    <li><a href="index-3.html">Home V2</a>
                                    </li>
                                    <li><a href="index-4.html">Home V3</a>
                                    </li>
                                    <li><a href="index-5.html">Home V4</a>
                                    </li>
                                    <li><a href="index-6.html">Home V5</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li><a href="hotel-version-one.html">Hotels</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="https://getnajmul.com/">Hotel Two</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="https://getnajmul.com/">Blog Two </a>
                                    </li>
