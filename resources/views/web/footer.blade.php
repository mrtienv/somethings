            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-footer">
                    <div class="footer-title">
                        <a href="#"><img src="/web/images/logo.png" alt="">
                        </a>
                    </div>
                    <div class="footer-left">
                        ...
                        <ul class="footer-contact">
                            <li><img class="map" src="/web/images/icon/map.png" alt="">Seventh Avenue New York</li>
                            <li><img class="map" src="/web/images/icon/phone.png" alt="">+123-456-7890</li>
                            <li><img class="map" src="/web/images/icon/gmail.png" alt="">info@yourcompany.com</li>
                        </ul>
                    </div>
                </div>
            </div> <!-- footer left -->
